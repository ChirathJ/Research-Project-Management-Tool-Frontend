...
export default function ReqSupervisor() {
  ...
  useEffect(() => {
    axios
      .get("https://sliit-research-management.herokuapp.com/groups/supervisor")
      .then((res) => {
          ...
          <div>
            ...
            <form>
              <div class="form-group">
                <label for="text1">Select Supervisor</label>
                <hr />
              ...
              <div className="login-button">
                <button
                  ...
                  onClick={() => {
                    axios
                      .post(
                        "https://sliit-research-management.herokuapp.com/groups/supervisor/request/topic",
                        {
